...
results_rf_tuned = pd.DataFrame({
    'mean_accuracy': [rf_tune_grid.best_score_],
    'sem_accuracy': [cv_results['std_test_accuracy'].iloc[rf_tune_grid.best_index_] / np.sqrt(10)],
...
# If you already have other results to concatenate with
# results = pd.concat([results, results_rf_tuned])

# If not, this will be your results DataFrame
results = results_rf_tuned
```
